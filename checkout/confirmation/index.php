...
if ($status === 'success') {
    ...
    echo "خطا در ذخیره اطلاعات: " . urldecode($message);
}
?>
...
<head>
    ...
    <title>تاییدیه رزرو | پلتفرم مشاوره آنلاین سلامت روان</title>
...
<body>
    ...
    <div class="container my-5 text-center">
        <h3 class="text-center pb-1">تاییدیه رزرو مشاوره</h3>
        <span class="text-secondary mb-5">اطلاعات رزرو خود را از این صفحه دریافت کنید</span>
    </div>

    <div class="container mt-5 text-center alert alert-success mb-5">
        <p class="fs-6">کاربر گرامی</p>
        <p class="fs-5">رزرو شما با شماره <?php echo "T6281" . $id; ?> با موفقیت ثبت شد.</p>
        <p> حتما در زمان انتخاب شده در سامانه حضور داشته باشید.</p>
        <p>در صورت عدم امکان حضور، لطفا به پشتیبانی اطلاع دهید.</p>
        <p>۱۵ دقیقه قبل از شروع در سامانه حضور داشته باشید.</p>
    </div>
